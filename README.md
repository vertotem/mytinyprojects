...
- [**莫斯代码练习器**：](./projects/morse/index.html) 一个可以可视化练习莫斯代码的网站，支持英文字母、数字、符号、谚文、假名、希腊字母、西里尔字母等。

### 带后端的工具

**注意：** 此处工具由于带后端，所以是部署在我自己的服务器上，可能随时终止服务。我会尽量提供源码

- [**AI六爻占卜**：](./projects/six-yao/index.html) 一个依据六爻占卜理论设计的科学的占卜网站，可以纯前端运行，只有AI解读功能需要后端。
